...
<html <?php language_attributes(); ?>>
	<head>
        ...
        <link rel="preload" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/fontawesome/css/fontawesome.min.css" as="style" onload="this.rel='stylesheet'">
        <link rel="preload" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/fontawesome/css/solid.min.css" as="style" onload="this.rel='stylesheet'">
        <link rel="preload" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/fontawesome/css/light.min.css" as="style" onload="this.rel='stylesheet'">
        <link rel="preload" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/fontawesome/css/regular.min.css" as="style" onload="this.rel='stylesheet'">
        <link rel="preload" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/fontawesome/css/brands.min.css" as="style" onload="this.rel='stylesheet'">
